...
TEST_DICT = {TEST_LIST_LIST[0][i]: TEST_LIST_LIST[1][i]
             for i in range(len(TEST_LIST_LIST[0]))}
...
class test_repr_wrapper(unittest.TestCase):
    ...
    def test_repr_return(self):
        self.assertEqual(repr_return(dict)(a=1,b=2,c=3),
                         { 'a': 1, 'b': 2, 'c': 3})
    ...
    def test_list_dict(self):
        ...
        self.assertEqual("[ { 'a': 'a', 'b': 1, 'c': 0.0, 'd': 1.0, "
                         "'e': 2.12, 'f': 3.123, 'g': 4.1234},"
                         "  { 'a': 'a', 'b': 1, 'c': 0.0, 'd': 1.0, "
                         "'e': 2.12, 'f': 3.123, 'g': 4.1234},"
                         "  { 'a': 'a', 'b': 1, 'c': 0.0, 'd': 1.0, "
                         "'e': 2.12, 'f': 3.123, 'g': 4.1234}]",
